...
declare -gA ENV_REQUIRED_KEYS=(
  ...
  [apiary]="POSTGRES_APIARY_PASSWORD INTERNAL_SERVICE_TOKEN NOTIFICATION_SERVICE_URL"
  [hive]="POSTGRES_HIVE_PASSWORD INTERNAL_SERVICE_TOKEN NOTIFICATION_SERVICE_URL"
  [inspection]="POSTGRES_INSPECTION_PASSWORD INTERNAL_SERVICE_TOKEN NOTIFICATION_SERVICE_URL"
  [harvest]="POSTGRES_HARVEST_PASSWORD INTERNAL_SERVICE_TOKEN NOTIFICATION_SERVICE_URL"
  ...
  [notification]="POSTGRES_NOTIFICATION_PASSWORD INTERNAL_SERVICE_TOKEN FIREBASE_PROJECT_ID FIREBASE_SERVICE_ACCOUNT_JSON_BASE64 AUTH_JWKS_URL REDIS_ADDR APPLE_BUNDLE_ID APPLE_KEY_ID APPLE_ISSUER_ID APPLE_PRIVATE_KEY APPLE_ENVIRONMENT"
)
