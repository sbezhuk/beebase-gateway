...
declare -gA ENV_REQUIRED_KEYS=(
  ...
  [apiary]="POSTGRES_APIARY_PASSWORD INTERNAL_SERVICE_TOKEN"
  [hive]="POSTGRES_HIVE_PASSWORD INTERNAL_SERVICE_TOKEN"
  [inspection]="POSTGRES_INSPECTION_PASSWORD INTERNAL_SERVICE_TOKEN"
  [harvest]="POSTGRES_HARVEST_PASSWORD INTERNAL_SERVICE_TOKEN"
